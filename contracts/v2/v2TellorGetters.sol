...
import "./libraries/v2SafeMath.sol";
import "./libraries/v2TellorStorage.sol";
import "./libraries/v2TellorTransfer.sol";
import "./libraries/v2TellorGettersLibrary.sol";
import "./libraries/v2TellorStake.sol";
...
*/
contract v2TellorGetters {
    using v2SafeMath for uint256;

    using v2TellorTransfer for v2TellorStorage.TellorStorageStruct;
    using v2TellorGettersLibrary for v2TellorStorage.TellorStorageStruct;
    using v2TellorStake for v2TellorStorage.TellorStorageStruct;

    v2TellorStorage.TellorStorageStruct tellor;
