...
*/
library v2TellorGettersLibrary {
    ...
    */
    function changeDeity(v2TellorStorage.TellorStorageStruct storage self, address _newDeity) internal {
    ...
    */
    function changeTellorContract(v2TellorStorage.TellorStorageStruct storage self, address _tellorContract) internal {
        require(self.addressVars[keccak256("_deity")] == msg.sender, "Sender is not deity");
    ...
    */
    function didMine(v2TellorStorage.TellorStorageStruct storage self, bytes32 _challenge, address _miner) public view returns (bool) {
    ...
    */
    function didVote(v2TellorStorage.TellorStorageStruct storage self, uint256 _disputeId, address _address) internal view returns (bool) {
    ...
    */
    function getAddressVars(v2TellorStorage.TellorStorageStruct storage self, bytes32 _data) internal view returns (address) {
    ...
    */
    function getAllDisputeVars(v2TellorStorage.TellorStorageStruct storage self, uint256 _disputeId)
        internal
        view
        returns (bytes32, bool, bool, bool, address, address, address, uint256[9] memory, int256)
    {
        v2TellorStorage.Dispute storage disp = self.disputesById[_disputeId];
        return (
            disp.hash,
            disp.executed,
    ...
    */
    function getCurrentVariables(v2TellorStorage.TellorStorageStruct storage self)
        internal
        view
    ...
    */
    function getDisputeIdByDisputeHash(v2TellorStorage.TellorStorageStruct storage self, bytes32 _hash) internal view returns (uint256) {
    ...
    */
    function getDisputeUintVars(v2TellorStorage.TellorStorageStruct storage self, uint256 _disputeId, bytes32 _data)
        internal
        view
        returns (uint256)
    {
    ...
    */
    function getLastNewValue(v2TellorStorage.TellorStorageStruct storage self) internal view returns (uint256, bool) {
        return (
            retrieveData(
                self,
    ...
    */
    function getLastNewValueById(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId) internal view returns (uint256, bool) {
        v2TellorStorage.Request storage _request = self.requestDetails[_requestId];
    ...
    */
    function getMinedBlockNum(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId, uint256 _timestamp)
        internal
        view
        returns (uint256)
    {
    ...
    */
    function getMinersByRequestIdAndTimestamp(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId, uint256 _timestamp)
        internal
        view
    ...
    */
    function getNewValueCountbyRequestId(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId) internal view returns (uint256) {
    ...
    */
    function getRequestIdByRequestQIndex(v2TellorStorage.TellorStorageStruct storage self, uint256 _index) internal view returns (uint256) {
    ...
    * @return uint of reqeuestId
    */
    function getRequestIdByTimestamp(v2TellorStorage.TellorStorageStruct storage self, uint256 _timestamp) internal view returns (uint256) {
    ...
    */
    function getRequestIdByQueryHash(v2TellorStorage.TellorStorageStruct storage self, bytes32 _queryHash) internal view returns (uint256) {
    ...
    */
    function getRequestQ(v2TellorStorage.TellorStorageStruct storage self) internal view returns (uint256[51] memory) {
    ...
    */
    function getRequestUintVars(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId, bytes32 _data)
        internal
        view
        returns (uint256)
    {
    ...
    */
    function getRequestVars(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId)
        internal
        view
    ...
    */
    function getStakerInfo(v2TellorStorage.TellorStorageStruct storage self, address _staker) internal view returns (uint256, uint256) {
    ...
    */
    function getSubmissionsByTimestamp(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId, uint256 _timestamp)
        internal
        view
    ...
    */
    function getTimestampbyRequestIDandIndex(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestID, uint256 _index)
        internal
        view
        returns (uint256)
    {
    ...
    */
    function getUintVar(v2TellorStorage.TellorStorageStruct storage self, bytes32 _data) internal view returns (uint256) {
    ...
    */
    function getVariablesOnDeck(v2TellorStorage.TellorStorageStruct storage self) internal view returns (uint256, uint256, string memory) {
    ...
    */
    function getTopRequestID(v2TellorStorage.TellorStorageStruct storage self) internal view returns (uint256 _requestId) {
        uint256 _max;
        uint256 _index;
        (_max, _index) = v2Utilities.getMax(self.requestQ);
    ...
    */
    function isInDispute(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId, uint256 _timestamp) internal view returns (bool) {
    ...
    */
    function retrieveData(v2TellorStorage.TellorStorageStruct storage self, uint256 _requestId, uint256 _timestamp)
        internal
        view
        returns (uint256)
    {
    ...
    */
    function totalSupply(v2TellorStorage.TellorStorageStruct storage self) internal view returns (uint256) {
