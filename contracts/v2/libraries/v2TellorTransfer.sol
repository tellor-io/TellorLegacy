...
library v2TellorTransfer {
    ...
    */
    function transfer(v2TellorStorage.TellorStorageStruct storage self, address _to, uint256 _amount) public returns (bool success) {
    ...
    */
    function transferFrom(v2TellorStorage.TellorStorageStruct storage self, address _from, address _to, uint256 _amount)
        public
    ...
    */
    function approve(v2TellorStorage.TellorStorageStruct storage self, address _spender, uint256 _amount) public returns (bool) {
    ...
    */
    function allowance(v2TellorStorage.TellorStorageStruct storage self, address _user, address _spender) public view returns (uint256) {
    ...
    */
    function doTransfer(v2TellorStorage.TellorStorageStruct storage self, address _from, address _to, uint256 _amount) public {
    ...
    */
    function balanceOf(v2TellorStorage.TellorStorageStruct storage self, address _user) public view returns (uint256) {
    ...
    */
    function balanceOfAt(v2TellorStorage.TellorStorageStruct storage self, address _user, uint256 _blockNumber) public view returns (uint256) {
        v2TellorStorage.Checkpoint[] storage checkpoints = self.balances[_user];
    ...
    */
    function allowedToTrade(v2TellorStorage.TellorStorageStruct storage self, address _user, uint256 _amount) public view returns (bool) { 
    ...
    */
    function updateBalanceAtNow(v2TellorStorage.Checkpoint[] storage checkpoints, uint256 _value) public {
        if (checkpoints.length == 0 || checkpoints[checkpoints.length - 1].fromBlock != block.number) {
           checkpoints.push(v2TellorStorage.Checkpoint({
                fromBlock : uint128(block.number),
                value : uint128(_value)
            }));
        } else {
            v2TellorStorage.Checkpoint storage oldCheckPoint = checkpoints[checkpoints.length - 1];
