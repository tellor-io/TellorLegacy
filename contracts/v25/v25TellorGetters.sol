...
/**
* @title v25Tellor Getters
* @dev Oracle contract with all tellor getter functions. The logic for the functions on this contract
* is saved on the v25TellorGettersLibrary, v25TellorTransfer, v25TellorGettersLibrary, and v25TellorStake
*/
contract v25TellorGetters {
    using v25SafeMath for uint256;

    using v25TellorTransfer for v25TellorStorage.TellorStorageStruct;
    using v25TellorGettersLibrary for v25TellorStorage.TellorStorageStruct;
