...
import "./libraries/v25SafeMath.sol";
import "./libraries/v25TellorStorage.sol";
import "./libraries/v25TellorTransfer.sol";
import "./libraries/v25TellorDispute.sol";
import "./libraries/v25TellorStake.sol";
import "./libraries/v25TellorLibrary.sol";

/**
 * @title v25Tellor Oracle System
 * @dev Oracle contract where miners can submit the proof of work along with the value.
 * The logic for this contract is in v25TellorLibrary.sol, v25TellorDispute.sol, v25TellorStake.sol,
 * and v25TellorTransfer.sol
 */
contract v25Tellor {
    using v25SafeMath for uint256;

    using v25TellorDispute for v25TellorStorage.TellorStorageStruct;
    using v25TellorLibrary for v25TellorStorage.TellorStorageStruct;
    using v25TellorStake for v25TellorStorage.TellorStorageStruct;
    using v25TellorTransfer for v25TellorStorage.TellorStorageStruct;

    v25TellorStorage.TellorStorageStruct tellor;
