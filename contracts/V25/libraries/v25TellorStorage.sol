...
/**
 * @title v25Tellor Oracle Storage Library
 * @dev Contains all the variables/structs used by v25Tellor
 */

library v25TellorStorage {
    ...
    struct TellorStorageStruct {
        ...
        //Address fields in the v25Tellor contract are saved the addressVars mapping
        //e.g. addressVars[keccak256("tellorContract")] = address
        //These are the variables saved in this mapping:
        // address keccak256("tellorContract");//v25Tellor address
        // address  keccak256("_owner");//v25Tellor Owner address
        // address  keccak256("_deity");//v25Tellor Owner that can do things at will
        // address  keccak256("pending_owner"); // The proposed new owner
        mapping(bytes32 => uint256) uintVars;
        //uint fields in the v25Tellor contract are saved the uintVars mapping
